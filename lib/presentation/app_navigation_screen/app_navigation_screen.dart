...
class _AppNavigationScreen extends State<AppNavigationScreen> {
  ...
  onTapHomeOnboarding() {
    Get.toNamed(AppRoutes.homeOnboardingScreen);
  }
  ...
  onTapLocationEntry() {
    Get.toNamed(AppRoutes.locationEntryScreen);
  }
  ...
  onTapMakePayment() {
    Get.toNamed(AppRoutes.makePaymentScreen);
  }
